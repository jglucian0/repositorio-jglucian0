  ...
  return (
    <div className="min-h-screen bg-[#090e16] text-white font-raleway">
      ...
      <header ref={headerRef} className="w-full">
        ...
        {isSticky && (
          <div
            className="fixed top-0 left-0 right-0 z-50 bg-[rgba(9,14,22,0.92)] backdrop-blur-sm"
            data-animate
          >
            <div className="max-w-[1640px] mx-auto px-[140px] py-3">
              <div className="w-full h-12 rounded-2xl bg-[rgba(65,127,111,0.03)] flex items-center justify-between px-4">
                ...
                <nav className="flex items-center gap-[14px]">
                  <a
                    href="#about"
                    className="text-[rgba(255,255,255,0.75)] text-sm hover:text-[#417F6F]"
                  >
                    Sobre mim
                  </a>
                  <a
        ...
        <div
          className="w-full max-w-[1640px] mx-auto px-[140px] pt-[38px]"
          data-animate
        >
          <div className="w-full h-16 rounded-2xl bg-[rgba(65,127,111,0.05)] relative flex items-center justify-between px-6">
            ...
            <nav className="flex items-center gap-[17px]">
              <a
                href="#"
                className="text-[rgba(65,127,111,0.50)] font-bold text-lg hover:text-[#417F6F] transition-colors"
              >
                Home
              </a>
              <a
                href="#about"
                className="text-white font-normal text-lg hover:text-[#417F6F] transition-colors"
              >
                Sobre mim
              </a>
              <a
      ...
      <div className="w-full max-w-[1920px] mx-auto relative">
        ...
        <section className="relative px-[140px] pt-[155px]">
          ...
          <div className="w-[411px]" data-animate>
            <div className="w-40 h-[45px] rounded-2xl bg-[rgba(65,127,111,0.10)] flex items-center justify-center mb-6">
              <span className="text-[#417F6F] font-bold text-xl">
                👋 Saudações!
              </span>
            </div>
          ...
          {/* Hero Image centered */}
          <div
            className="absolute left-1/2 transform -translate-x-1/2 top-[115px]"
            data-animate
          >
            <img
          ...
          <div
            className="absolute right-[140px] top-[260px] flex flex-col gap-4 items-end"
            data-animate
          >
            {/* Download CV Button */}
            <div className="flex items-center gap-4">
        ...
        <section id="about" className="px-[140px] pt-[166px]">
          <div className="max-w-[1640px] mx-auto text-center" data-animate>
            ...
            <h2 className="text-5xl font-black text-white mb-[53px]">
        ...
        <section id="portfolio" className="px-[140px] pt-[194px]">
          ...
          <div className="flex gap-14 max-w-[1608px] mx-auto mb-[90px]">
            {/* Project Card 1 */}
            <div
              className="w-[360px] h-[460px] rounded-2xl border border-[rgba(65,127,111,0.50)] p-8"
              data-animate
            >
              ...
              <div className="flex gap-4 mb-8">
                <span className="px-2 py-1 bg-[rgba(74,226,144,0.30)] text-[#4AE290] text-sm font-bold rounded">
                  Online
                </span>
                <span className="px-2 py-1 bg-[rgba(65,127,111,0.10)] text-[#417F6F] text-sm font-bold rounded">
                  Typescript
                </span>
              </div>
            ...
            <div
              className="w-[360px] h-[460px] rounded-2xl bg-[rgba(65,127,111,0.10)] p-8"
              data-animate
            >
              <h3 className="text-xl font-bold text-white mb-4">Move.it</h3>
              <p className="text-sm text-[rgba(255,255,255,0.50)] mb-8 h-[100px]">
          ...
          <div className="text-center" data-animate>
            <a
              href="#"
              className="text-[#417F6F] text-xl font-semibold hover:opacity-80 transition-opacity inline-flex items-center gap-4"
            >
          ...
          <div className="max-w-[1640px] mx-auto">
            ...
            <div className="flex mb-[64px]">
              <div className="w-1/2 text-center">
                <h3 className="text-[32px] font-black text-white mb-2">
                  Área profissional
                </h3>
                <p className="text-2xl text-[rgba(255,255,255,0.50)]">
                  2016 · Atualmente
                </p>
              </div>
              <div className="w-1/2 text-center">
            ...
            <div className="space-y-[64px]">
              ...
              <div className="flex gap-[85px]">
                {/* Professional */}
                <div
                  className="w-[580px] h-[220px] rounded-2xl border border-[rgba(65,127,111,0.00)] bg-[rgba(65,127,111,0.10)] p-8"
                  data-animate
                >
                  <h4 className="text-xl font-bold text-white mb-4">
                    Desenvolvedor Front-end na Ensinio
                  </h4>
                  <p className="text-base text-[rgba(255,255,255,0.50)] mb-8">
                    Desenvolvimento de features na aplicação principal e site.
                    com React Js e Typescript, além do auxíllio de outras
                    tecnologias como Next, Styled Components e padrões de
                    arquitetura.
                  </p>
                  <div className="flex justify-between items-center">
                    <span className="text-lg font-bold text-[#417F6F]">
                      1 ano e 7 meses
                    </span>
                    <span className="text-lg text-[#417F6F]">
                ...
                {/* Academic */}
                <div
                  className="w-[580px] h-[220px] rounded-2xl border border-[rgba(65,127,111,0.50)] p-8"
                  data-animate
                >
                  <h4 className="text-xl font-bold text-white mb-4">
                  ...
                  <p className="text-base text-[rgba(255,255,255,0.50)] mb-8">
                    Recém graduado pela FATEC de São José dos Campos no curso de
          ...
          <div className="max-w-[663px] mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-6 mb-6">
              <a
                ...
                className="text-xl text-[rgba(255,255,255,0.50)] hover:text-white transition-colors"
              >
              ...
              <button className="w-[246px] h-[60px] border border-[rgba(65,127,111,0.50)] rounded-2xl flex items-center justify-center gap-4 hover:bg-[rgba(65,127,111,0.1)] transition-colors">
                ...
                <span className="text-xl font-semibold text-[rgba(65,127,111,0.50)]">
                  Vamos conversar
                </span>
              </button>
            </div>
            ...
            <div className="mt-6 text-center">
              <a
                href="#top"
                className="text-xl font-semibold text-[rgba(65,127,111,0.50)] hover:opacity-80 transition-opacity inline-flex items-center gap-4"
              >
                Voltar ao topo
              </a>
            </div>
      ...
      {/* Footer */}
      <footer
        className="w-full h-[88px] bg-[rgba(65,127,111,0.1)] mt-[100px] flex items-center justify-between px-[140px]"
        data-animate
      >
        <p className="text-base text-[rgba(255,255,255,0.50)]">
          Copyright © João Gabriel Luciano · 2025
        </p>
